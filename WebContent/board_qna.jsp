...
<script type="text/javascript">
	...
	function search() {
		...
		location.href = "semi.do?command=board_qna&s_c=" + s_c + "&s_t=" + s_t
				+ "&category=Q";
	}
</script>
</head>
		...
		<div class="container">
			...
			<div class="table-responsive">
				<form action="semi.do" method="post" id="muldelform">
					...
					<%-- 삭제 후 장소 이동 --%>
					<input type="hidden" name="where" value="board_qna">
							...
							<c:if test="${dto ne null }">
								<tr>
									<td colspan="6" style="text-align: right;">
										<input type="button" class="s-btn" value="글작성" onclick="location.href='semi.do?command=board_insertform&category=Q'" />
