								...
								<c:otherwise>
									...
									<c:forEach items="${s_list }" var="dto"> 
										...
										<tr>
											...
											<input type="submit" value="주문취소요청" class="s-btn" formaction="semi.do?command=order_my_update"
										                          formmethod="post"/>
											</td>
										</tr>
								</c:otherwise>
								...
								<c:otherwise>
									...
									<c:forEach items="${list }" var="dto"> 
										...
										<tr>
											...
											<input type="submit" value="목록삭제" class="s-btn" formaction="semi.do?command=order_my_delete"
										                          formmethod="post"/>
											</td>
										</tr>
								</c:otherwise>
