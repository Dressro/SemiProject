...
<body>
	...
	<div>
		<form action="semi.do" method="post" onsubmit="return submitUserForm();">
			...
			<input type="text" name="member_id" placeholder="아이디 입력" required="required"><br> 
			<input type="password" name="member_password" placeholder="비밀번호 입력" required="required"><br>
			...
			<!-- 로그인api이미지 적용 -->
			<button type="button" id="snsloginBtn">
				<img src="#" />카카오ID로그인
			</button>
			<br>
			<!-- 네이버아이디로로그인 버튼 노출 영역 -->
		...
		<!-- google reCaptcha -->
			<div class="g-recaptcha"
				data-sitekey="6LfGNrAaAAAAACnlQAb1RFvF-DQJApSARniYjGki" data-callback="verifyCaptcha" ></div>
