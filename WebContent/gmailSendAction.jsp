<%@page import="com.project.fp.gmail.Gmail"%>
<%@page import="com.project.fp.gmail.SHA256"%>
...
<%
	...
	String host = "http://localhost:8787/SemiProject/";		
	String from = "hdg951002@gmail.com";
	...
	String content = "다음 링크에 접속하여 이메일 인증을 진행해주세요. " 
	        + "<a href='" + "semi.do?command=mailcheck&code=" + code
			+ "'>이메일 인증하기</a>";
