...
insert into animal values(animal_no_seq.nextval,'냥이','M','','','','','Dressro');
...
SELECT * FROM ANIMAL;
insert into file_table values(file_num_seq.nextval,'path','ori_name','new_name','.html',sysdate,'100byte','Dressro','2','1','1');